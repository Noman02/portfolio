...
const About = () => {
  return (
   <>
      ...
      >
        I'm a skilled front-end developer with experience in Javascript and expertise in frameworks like React, I'm a quick learner and collaborate closely with clients to
